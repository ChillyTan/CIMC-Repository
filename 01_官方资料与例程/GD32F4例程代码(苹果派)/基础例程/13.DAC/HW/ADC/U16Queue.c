...
* 注    意：
*********************************************************************************************************/
void  InitU16Queue(StructU16CirQue* pQue, unsigned short* pBuf, signed short len)
{
  signed short i;
...
* 注    意：
*********************************************************************************************************/
unsigned char    U16QueueEmpty(StructU16CirQue* pQue)
{
...
* 注    意：
*********************************************************************************************************/
signed short   U16QueueLength(StructU16CirQue* pQue)
{
  return(pQue->elemNum);
}
...
*********************************************************************************************************/
signed short EnU16Queue(StructU16CirQue* pQue, unsigned short* pInput, signed short len)
{
...
*********************************************************************************************************/
signed short DeU16Queue(StructU16CirQue* pQue, unsigned short* pOutput, signed short len)
{
