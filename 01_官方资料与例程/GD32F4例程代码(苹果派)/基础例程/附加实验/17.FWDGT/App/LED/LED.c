...
* 注    意：
*********************************************************************************************************/
void SetLEDSts(unsigned char sts)
{
  if(sts & 0x01)                                
  {
    gpio_bit_set(GPIOB, GPIO_PIN_5);      //LED1点亮
  }
  else
  {
    gpio_bit_reset(GPIOB, GPIO_PIN_5);    //LED1熄灭
  }
  
  if(sts & 0x02)
  {
    gpio_bit_set(GPIOI, GPIO_PIN_8);      //LED2点亮
  }
  else
  {
    gpio_bit_reset(GPIOI, GPIO_PIN_8);    //LED2熄灭
  }
}
