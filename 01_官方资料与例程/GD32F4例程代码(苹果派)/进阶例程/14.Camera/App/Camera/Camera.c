...
*                                              内部函数声明
*********************************************************************************************************/
static void PreviouCallback(EnumGUIRadio item);     //前一项按钮回调函数
static void NextCallback(EnumGUIRadio item);        //下一项按钮回调函数
static void RadioChangeCallback(EnumGUIRadio item); //单选切换按钮回调函数
...
* 注    意：
*********************************************************************************************************/
static void RadioChangeCallback(EnumGUIRadio item)
{
  //切换到色度调节
...
void InitCamera(void)
{
  ...
  s_structGUIDev.radioChangeCallback = RadioChangeCallback;
  s_structGUIDev.takePhotoCallback   = NULL;
