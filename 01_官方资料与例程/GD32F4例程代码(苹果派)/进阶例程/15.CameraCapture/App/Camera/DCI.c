...
*                                              内部变量
*********************************************************************************************************/
static u32 s_iFrameAddr, s_iFrameSize;        //帧地址以及帧大小
static u32 s_iX0, s_iY0, s_iWidth, s_iHeight; //图像显示信息
static u32 s_iMode;                           //显示模式，0-直接加载到显存，1-加载到临时缓冲区后再显示
static u32 s_iGetFrameFlag;                   //获得1帧图像标志位
...
static void ConfigDCI(void);     //配置DCI
