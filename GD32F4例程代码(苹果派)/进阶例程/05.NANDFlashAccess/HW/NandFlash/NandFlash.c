...
u32 InitNandFlash(void)
{
  ...
  nand_timing_init_struct.setuptime       = 6; //建立时间
  nand_timing_init_struct.waittime        = 6; //等待时间
  nand_timing_init_struct.holdtime        = 3; //保持时间
  nand_timing_init_struct.databus_hiztime = 3; //高阻态时间
