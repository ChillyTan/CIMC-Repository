...
void InitGUILineEdit(void)
{
  ...
  s_structWriteAddrHasFocusImage.image = (u8*)s_arrJpegWriteAddrHasFocusImage290x50x24;
  s_structWriteAddrHasFocusImage.size = sizeof(s_arrJpegWriteAddrHasFocusImage290x50x24) / sizeof(u8);
  s_structWriteAddrNoFocusImage.image = (u8*)s_arrJpegWriteAddrNoFocusImage290x50x24;
  s_structWriteAddrNoFocusImage.size = sizeof(s_arrJpegWriteAddrNoFocusImage290x50x24) / sizeof(u8);
  ...
  s_structWriteDataHasFocusImage.image = (u8*)s_arrJpegWriteDataHasFocusImage290x50x24;
  s_structWriteDataHasFocusImage.size = sizeof(s_arrJpegWriteDataHasFocusImage290x50x24) / sizeof(u8);
  s_structWriteDataNoFocusImage.image = (u8*)s_arrJpegWriteDataNoFocusImage290x50x24;
  s_structWriteDataNoFocusImage.size = sizeof(s_arrJpegWriteDataNoFocusImage290x50x24) / sizeof(u8);
  ...
  s_structReadAddrHasFocusImage.image = (u8*)s_arrJpegReadAddrHasFocusImage210x50x24;
  s_structReadAddrHasFocusImage.size = sizeof(s_arrJpegReadAddrHasFocusImage210x50x24) / sizeof(u8);
  s_structReadAddrNoFocusImage.image = (u8*)s_arrJpegReadAddrNoFocusImage210x50x24;
  s_structReadAddrNoFocusImage.size = sizeof(s_arrJpegReadAddrNoFocusImage210x50x24) / sizeof(u8);
  ...
  s_structReadLenHasFocusImage.image = (u8*)s_arrJpegReadLenHasFocusImage210x50x24;
  s_structReadLenHasFocusImage.size = sizeof(s_arrJpegReadLenHasFocusImage210x50x24) / sizeof(u8);
  s_structReadLenNoFocusImage.image = (u8*)s_arrJpegReadLenNoFocusImage210x50x24;
  s_structReadLenNoFocusImage.size = sizeof(s_arrJpegReadLenNoFocusImage210x50x24) / sizeof(u8);
...
{
  //显示最大字符数量
  static const u8 s_arrTextMaxLen[GUI_LINE_EDIT_MAX] = {8, 2, 8, 2};
