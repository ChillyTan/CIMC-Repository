...
void CreateGUIRS485(void)
{
  ...
  //显示背景图片
  DisPlayBMPByIPA(0, 0, RS485_BACKGROUND_DIR);
  ...
  s_structKeyPressImage.addr        = (void*)RS485_BUTTON_PRESS_DIR;
  ...
  s_structKeyReleaseImage.addr        = (void*)RS485_BUTTON_RELEASE_DIR;
  ...
  s_structHasFocusImage.image = (unsigned char*)RS485_LINE_EDIT_HAS_FOCUS_DIR;
  s_structNoFocusImage.image = (unsigned char*)RS485_LINE_EDIT_NO_FOCUS_DIR;
  ...
  s_structTerminalImage.image = (unsigned char*)RS485_TERMINAL_DIR;
  ...
  gpio_output_options_set(GPIOB, GPIO_OTYPE_PP, GPIO_OSPEED_200MHZ, GPIO_PIN_2);
  gpio_bit_reset(GPIOB, GPIO_PIN_2);
}
