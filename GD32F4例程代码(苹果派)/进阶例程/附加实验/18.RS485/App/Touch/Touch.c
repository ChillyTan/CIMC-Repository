...
/*********************************************************************************************************
* 函数名称：GetTouch1Result
* 函数功能：获得触点1扫描结果
* 输入参数：point：触点指针
* 输出参数：void
* 返 回 值：1-触点1按下，0-触点1释放
* 创建日期：2021年07月01日
* 注    意：
*********************************************************************************************************/
u8 GetTouch1Result(StructTouchPoint* point)
{
  point->x = s_structTouchDev.point[0].x;
  point->y = s_structTouchDev.point[0].y;
  point->size = s_structTouchDev.point[0].size;
  return s_structTouchDev.pointFlag[0];
}
