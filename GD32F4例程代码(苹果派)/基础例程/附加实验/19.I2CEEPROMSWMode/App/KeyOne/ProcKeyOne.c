...
*                                              内部变量
*********************************************************************************************************/
static u8 pBuffer1[] = "hello world!";
static u8 pBuffer2[] = "hello MCU!";
static u8 pBuffer3[sizeof(pBuffer1)]; 
...
{  
  //printf("KEY1 PUSH DOWN\r\n");  //打印按键状态
	AT24CxxWrite(0x55, pBuffer1, sizeof(pBuffer1));
  printf("write:%s to address 0x55\r\n", pBuffer1);
}
...
void  ProcKeyDownKey2(void)
{
  //printf("KEY2 PUSH DOWN\r\n");   //打印按键状态
	AT24CxxWrite(0x55, pBuffer2, sizeof(pBuffer2));
  printf("write:%s to address 0x55\r\n", pBuffer2);
}
...
void  ProcKeyDownKey3(void)
{
  //printf("KEY3 PUSH DOWN\r\n");   //打印按键状态
	AT24CxxRead(0x55, pBuffer3, sizeof(pBuffer3));
  printf("read:%s to from 0x55\r\n", pBuffer3);
}
