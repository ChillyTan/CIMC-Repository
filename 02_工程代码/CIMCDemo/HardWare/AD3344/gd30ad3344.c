...
/************************* 内部函数声明 *************************/
static void ConfigAD3344CS(void);	//配置AD3344
static u16  AD3344Transfer16(u16 half_word);	//发送发送16位数据
static void ad3344_ExtRef(void);	//配置AIN3作为外部参考
static float GetMedianFloat(float *buf, u8 len);	//取某个数组中的中位数
